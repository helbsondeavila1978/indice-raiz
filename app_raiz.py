...
# ==============================================================================
# CONFIGURAÇÃO DE PÁGINA E IDENTIDADE VISUAL EDITORIAL (IASC / REVISTA AMEFRICANA)
# ==============================================================================
st.set_page_config(
...
# CSS Estrutural Focado em Legibilidade, Estabilidade e Autoridade Institucional
st.markdown("""
    <style>
    ...
    /* Caixa Diagnóstica de Alto Impacto */
    .caixa-resultado {
        padding: 30px;
        border-radius: 8px;
        text-align: center;
...
# ==============================================================================
# BARRA LATERAL: FUNDAMENTAÇÃO E PARÂMETROS
# ==============================================================================
with st.sidebar:
...
# ==============================================================================
# ÁREA CENTRAL: APRESENTAÇÃO INSTITUCIONAL
# ==============================================================================
...
st.write("A aplicação deste instrumento metodológico exige do pesquisador e do ativista uma leitura arguta da materialidade do serviço público. O dispositivo a seguir foi estruturado para capturar a discricionariedade técnica que frequentemente mascara a necropolítica. Avalie cada dimensão sabendo que valores negativos denunciarão o desmonte, enquanto positivos validarão o avanço estrutural contundente na reparação e redistribuição de poder.")
st.divider()

# ==============================================================================
# MATRIZ AVALIATIVA DE TEORIA SOCIAL CRÍTICA
# ==============================================================================
eixos = {
    "Eixo 1: Território e Memória": [
        ("Memória: A lei protege ativamente e fomenta a preservação de espaços de memória afro-brasileira e indígena, repelindo o apagamento histórico.", 0.4),
        ("Distribuição: Os recursos e serviços previstos pela norma são distribuídos de forma rigorosamente equitativa, priorizando bairros periféricos.", 0.3),
        ("Acesso: O ato normativo elimina barreiras financeiras e burocráticas, assegurando a proximidade física de direitos essenciais.", 0.3),
        ("Capilaridade Física: A execução alcança efetivamente as áreas mais precarizadas (encostas, ruas sem asfalto, vielas).", 0.5),
        ("Capilaridade Estrutural: O Estado descentraliza operações investindo nas infraestruturas comunitárias já existentes no território.", 0.5)
    ],
    "Eixo 2: Corpos e Vivências": [
        ...
        ("Proteção: A aplicação da norma protege concretamente a integridade física e mental da população racializada contra a negligência.", 0.3),
        ("Escuta: As demandas e as percepções orgânicas da comunidade foram validadas e incorporadas de forma decisiva na redação legal.", 0.3),
        ("Capilaridade Cotidiana: A mudança estrutural melhora efetivamente a exaustiva rotina diária da classe trabalhadora.", 0.5),
        ("Capilaridade Social: A norma possui mecanismos de busca ativa para proteger pessoas em situação de extrema invisibilidade.", 0.5)
    ],
    "Eixo 3: Poder e Representação": [
        ("Participação: Lideranças comunitárias periféricas exerceram poder material de veto e alteração significativa no texto da lei.", 0.4),
        ("Decisão: Conselhos responsáveis pela execução possuem mecanismos obrigatórios (cotas/paridade) para presença negra e indígena.", 0.3),
        ("Narrativa: Campanhas e textos oficiais constroem narrativas que valorizam a cultura marginalizada, rompendo estigmas.", 0.3),
        ("Capilaridade Fiscalizadora: A norma garante financiamento de canais para os moradores fiscalizarem resultados práticos.", 0.5),
        ("Capilaridade Decisória: O Estado transfere recursos financeiros e repassa o poder de gestão diretamente para associações comunitárias.", 0.5)
    ],
    "Eixo 4: Estado e Responsabilidade": [
        ...
        ("Capilaridade de Infraestrutura: Os equipamentos públicos nas periferias receberam o aporte material e humano indispensável.", 0.5)
    ],
    "Eixo 5: Conhecimento e Linguagem": [
        ...
        ("Violência Simbólica: O texto normativo e o atendimento utilizam linguagem emancipatória, abdicando de jargões jurídicos.", 0.3),
        ...
        ("Capilaridade Comunicacional: Informações cruciais chegam à população através de meios populares (rádios comunitárias, carros de som).", 0.5),
        ("Capilaridade Epistêmica: O Estado contrata lideranças que já existem dentro da própria comunidade para implementar ações.", 0.5)
    ]
}
...
# ==============================================================================
# PROCESSAMENTO DE DADOS E FORMULÁRIO ESTÁVEL
# ==============================================================================
...
# ==============================================================================
# RENDERIZAÇÃO DO VEREDITO E SÍNTESE DIAGNÓSTICA MATEMÁTICA
# ==============================================================================
if submit_button:
    ...
    # --------------------------------------------------------------------------
    # GRÁFICO DE TEIA (RADAR) - MAPEAMENTO MULTIDIMENSIONAL
    # --------------------------------------------------------------------------
    ...
    fig.add_trace(go.Scatterpolar(
        ...
        line=dict(color='#A64B2A', width=3),  # Terracota Principal
        marker=dict(color='#1A1A1A', size=8)  # Preto Suave
    ))
    ...
    fig.update_layout(
        polar=dict(
            ...
            angularaxis=dict(
                gridcolor='#DCDCDC',
                linecolor='#1A1A1A',
                tickfont=dict(size=14, color='#1A1A1A', family='Georgia')
            ),
            bgcolor='#FDFBF7'
        ),
